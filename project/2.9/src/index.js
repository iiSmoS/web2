...
import iiSmoS from './img/iiSmoS.jpg';
...
const createButton = (text,method) =>  {
  ...
  containerWrapper.appendChild(buttonDiv);
...
function createMyMovies(){
  ...
  createButton('About', createAboutPart);
}

function createAboutPart(){
  containerWrapper.innerHTML = ' ';

  createTitle('Back');

  createCard('iiSmoS',iiSmoS,'You are on the right path!');

  createButton('Back', createMyMovies);
}
